...
#ifndef TODO_APP_SWIFT_H
#define TODO_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="todo_app",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8todo_app11AppDelegate")
...
@interface Item (SWIFT_EXTENSION(todo_app))
...
@interface NSScrollView (SWIFT_EXTENSION(todo_app))
...
@interface Project (SWIFT_EXTENSION(todo_app))
...
SWIFT_CLASS("_TtC8todo_app18SwipeDetectingView")
@interface SwipeDetectingView : NSView
...
SWIFT_CLASS("_TtC8todo_app17SwipeDetectorView")
@interface SwipeDetectorView : NSView
- (nonnull instancetype)initWithFrame:(NSRect)frameRect OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)scrollWheel:(NSEvent * _Nonnull)event;
@end
...
@interface Tag (SWIFT_EXTENSION(todo_app))
- (void)addItemsObject:(Item * _Nonnull)value;
- (void)removeItemsObject:(Item * _Nonnull)value;
- (void)addItems:(NSSet * _Nonnull)values;
- (void)removeItems:(NSSet * _Nonnull)values;
...
SWIFT_CLASS("_TtC8todo_app19WeekScrollResponder")
@interface WeekScrollResponder : NSResponder
- (void)scrollWheel:(NSEvent * _Nonnull)event;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
